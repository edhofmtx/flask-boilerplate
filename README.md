...
Note: This is a modified version from flask boilerplate by mjhea0
      https://github.com/mjhea0/flask-boilerplate
      Adjusted with custom dark theme Bootstrap
      Please use python 2.7 or else an error may occured
